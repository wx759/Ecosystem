...
class Config:
    def __init__(self, scope: str, action_dim: int, action_bound: float, state_dim: int = 0, reward_gamma: int = 0.95, memory_capacity: int = 80000,
                 ...
                 learning_rate_decay: float = 1,learning_rate_decay_time:int=200,
                 ...
                 is_critic_double_network: bool = True,is_actor_update_delay:bool = True,is_QNet_smooth_critic:bool = True,is_lstm:bool = True,
                 policy_noise:float =0.2,discount:float = 0.99,max_hist_len=8,batch_lstm=256):
        self.scope = scope
