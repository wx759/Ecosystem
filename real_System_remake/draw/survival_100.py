...
def plot_avg_survival_days(excel_path, save_dir=None, filename='survival_days_comparison.svg', sheet_name=0):
    """
    ...
    # 定义各算法对应的列名
    td3_cols = [
        'td_100_5-eval/avg_survival_days_step',
        'td_100_4-eval/avg_survival_days_step',
        'td3_100_3-eval/avg_survival_days_step',
        'td3_100_2-eval/avg_survival_days_step',
        'td3_100_1-eval/avg_survival_days_step'
    ]

    mlp_cols = [
        'PPO_MLP_seed891_100-eval/avg_survival_days_step',
        'PPO_MLP_seed981_100-eval/avg_survival_days_step',
        'PPO_MLP_seed936_100-eval/avg_survival_days_step'
    ]

    transformer_cols = [
        'ppo_tf_seed891_100-eval/avg_survival_days_step',
        'ppo_tf_seed981_100-eval/avg_survival_days_step',
        'ppo_tf_seed936_100-eval/avg_survival_days_step'
    ]
    ...
    plt.ylabel('Average Survival Days', fontsize=14)
    plt.title('Comparison of Average Survival Days across Algorithms', fontsize=16)
...
if __name__ == "__main__":
    excel_path = "D:\experiment\data\compare\survival_day\day.xlsx"
